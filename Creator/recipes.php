 ...
 <script src="https://cdn.ckeditor.com/ckeditor5/41.2.1/classic/ckeditor.js"></script>
    ...
    <strong>Success!</strong> Added Failed
                ...
                ?>
                     ...
                     <form action="recipes_action.php" method="post">
...
if($count>0){
   ...
   <textarea id="editor" name="ingredients" required></textarea>
  </div>
   <div class="form-group">
    <label for="pwd">Instructions</label>
    <textarea id="editor1" name="instructions" required></textarea>
  </div>
   <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" required name="preparation_time" id="pwd">
  </div>
   <div class="form-group">
    <label for="pwd">Difficulty Level</label>
    <input type="text" class="form-control" id="pwd" required name="difficulty_level">
  </div>
   <div class="form-group">
    <label for="pwd">Storage Instructions</label>
    <textarea id="editor4" name="storage" required></textarea>
  </div>
   <div class="form-group">
    <label for="pwd">Video Link</label>
    <input type="text" class="form-control" required id="pwd" name="link">
  </div>
   <div class="form-group">
