                    ...
                    <table  class="table table-bordered table-striped" id="example"  style="width:100%">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><img src="http://campus.sicsglobal.co.in/Project/janani/api/uploads/<?php echo $row['license_pic'];?>"></td>
                          <td>
                          <?php echo $row['license_num'];?>
                          </td>
...
if($row['status']==2){
  ...
  echo 'Reject';
                            ...
                            ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="delete_seller.php?id=<?php echo $row['id'];?>">Delete</a></td>
                        </tr>
